...
AddHost("https://ibexfarm.ung.si/uporabniki/dk0035/experiment2/stimuli/")
...
{
  message_for_the_type_of_experiment = "Пилотен проект на експеримент 5";
  stimuli_csv_table="design_final.csv";
}
else if (type_of_experiment=="test-short")
{
  message_for_the_type_of_experiment = "Кратък тест на експеримент 5";
  stimuli_csv_table="test.csv";
}

else if (type_of_experiment=="test-full")
{
  message_for_the_type_of_experiment = "Пълен тест на експеримент 5";
  stimuli_csv_table="design_final.csv";
}
